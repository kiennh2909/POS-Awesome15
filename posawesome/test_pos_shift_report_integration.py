...
class TestPOSShiftReportIntegration(unittest.TestCase):
        ...
        try:
            ...
            for shift in test_shifts:
                try:
                    ...
                    print(f"Error deleting opening shift {shift.name}: {e}")
    ...
    def test_04_create_shift_report(self):
        ...
        shift_report = frappe.get_doc({
            ...
            "opening_time": opening_shift_doc.period_start_date.time() if opening_shift_doc.period_start_date else time(9, 0, 0),  # Use period_start_date from POS Opening Shift
    ...
    def test_11_complete_shift_workflow(self):
        ...
        # Step 5: Use existing POS Closing Shift (don't create new one)
        ...
        if frappe.db.exists("POS Closing Shift", closing_shift_name):
            ...
            self.fail(f"POS Closing Shift {closing_shift_name} does not exist!")

        print("✅ Complete shift workflow test passed")

        # Clean up - Don't delete real POS Closing Shift, only restore original reference
        try:
    ...
    def test_13_shift_closing_process(self):
        ...
        # Use existing POS Closing Shift (don't create new one)
        closing_shift_name = "POSA-CS-25-0000071"  # Real POS Closing Shift
